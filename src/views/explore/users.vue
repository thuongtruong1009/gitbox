...
import { sortUser } from '../../shared/sort'
    ...
    <div class="repositories_layout mx-auto dark:bg-black flex justify-center gap-10 p-10">
        ...
        <div class="repositories_view max-w-238 w-238 dark:bg-black">
            ...
            <div class="repositories_list w-full" v-if="user.isLoading === false">
                <div class="repo relative flex justify-between items-start bg-[#FAFAFA] dark:(bg-gray-900 hover:bg-gray-800 border-gray-700 shadow-gray-700) hover:bg-[#F6F6F6] shadow-md shadow-gray-300/50 duration-200 border-1 border-solid border-light-700/50 mt-2 rounded-xl py-2 px-5" v-for="trending in useExploreStore.usersSearch.items" :key="trending.id">
                    <div class="flex">
                ...
                <!-- <div class="flex justify-between items-end py-2">
                    <div class="loadmore-tab">
                        <button class="fill_btn">Load more...</button>
                    </div>
