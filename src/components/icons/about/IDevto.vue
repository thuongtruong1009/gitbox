<template>
	<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
		x="0px" y="0px" viewBox="0 0 64 64" width="2.2em" height="2.2em" style="enable-background:new 0 0 64 64;"
		xml:space="preserve">
		<g>
		...
		c-0.4-0.4-0.6-0.8-0.8-1.2C0.1,50.5,0,50.1,0,49.6z" />
			<g>
				<g>
					<path class="st1"
						d="M39.8,27.2c0.7,2.5,1.7,6.5,2.4,9c1,3.9,1.3,4.7,2.2,5.6c0.6,0.6,1.3,1,1.8,1c1,0,2.2-1,2.7-2.1
