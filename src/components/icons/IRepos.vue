    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="101" height="95" viewBox="0 0 101 95">
        ...
        <g fill="none" fill-rule="evenodd" style="mix-blend-mode:luminosity">
            <g transform="translate(2 31)">
                ...
                <path
                    fill="url(#a)"
                    d="M17.414 29.02l-.684 2.482 1.702 2.102.868-2.233-1.886-2.352z"
                />
                <path
                    fill="url(#b)"
            ...
            <path
                fill="url(#d)"
                d="M21.768 36.274l-.856 3.103 2.128 2.628 1.084-2.791-2.356-2.94z"
            ...
            <path
                ...
                opacity=".376"
                transform="rotate(-5 126.665 46.413)"
            />
            <path
                fill="url(#g)"
                d="M29.324 45.4l-.924 2.885L30.564 51l1.036-2.715-2.276-2.885z"
            ...
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
                    stroke="#243552"
                    stroke-width="5.4"
                    d="M37.014 40.666l13.339 10.177L61.84 25.772"
                    opacity=".586"
                />
                <path
                    stroke="url(#h)"
                    stroke-width="1.8"
                    d="M0 14.894l13.338 10.177L24.826 0"
            ...
            <g transform="translate(9 24)">
                <path
                    ...
                    filter="url(#j)"
                    opacity=".5"
                    transform="rotate(-80 19.155 17.638)"
                />
                <path
                    stroke="url(#k)"
                    stroke-width="1.26"
                ...
                <g transform="rotate(-4 171.528 -37.993)">
                    ...
                    <path
                        fill="#FFF"
                        fill-opacity="0.2"
                        d="M2.49.421c.773 0 1.46.375 1.89.953A2.332 2.332 0 0 0 2.962.896a2.367 2.367 0 0 0-2.36 2.375c0 .535.176 1.029.473 1.426A2.378 2.378 0 0 1 .13 2.796 2.367 2.367 0 0 1 2.49.42z"
                    />
                </g>
                <ellipse
                    cx="29.729"
                ...
                <path
                    fill="#FFF"
                    fill-opacity="0.2"
                    d="M31.405 18.532c-.047.383-.273.7-.586.878.172-.178.29-.41.322-.673a1.184 1.184 0 0 0-1.035-1.316 1.187 1.187 0 0 0-.736.148c.25-.258.615-.4 1-.353.651.08 1.115.669 1.035 1.316z"
                />
            </g>
            <g transform="translate(36)">
                <path
                    fill="url(#p)"
                    d="M13.245 13.448l1.481-.254L25.27 31.63l-1.254.567z"
                    filter="url(#q)"
                    opacity=".5"
                />
                <path
                ...
                <path
                    fill="#FFF"
                    fill-opacity="0.2"
                    d="M12.901 0c.774 0 1.46.374 1.89.953a2.332 2.332 0 0 0-1.418-.478 2.367 2.367 0 0 0-2.36 2.374c0 .536.176 1.03.474 1.427a2.378 2.378 0 0 1-.946-1.902A2.367 2.367 0 0 1 12.901 0z"
                />
                <ellipse cx="24.701" cy="31.343" fill="url(#s)" rx="1.416" ry="1.425" />
                <path
                    fill="#FFF"
                    fill-opacity="0.2"
                    d="M24.465 29.918c.386 0 .728.187.943.475a1.172 1.172 0 0 0-.707-.237c-.652 0-1.18.531-1.18 1.187 0 .268.088.514.236.713a1.188 1.188 0 0 1-.472-.95c0-.656.528-1.188 1.18-1.188z"
                />
                <ellipse
                    cx="24.446"
                    cy="31.237"
